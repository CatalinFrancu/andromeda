...
int Board::estimateRemainingMoves() {
  // Divide by 2 because the opponent can also create clones and drive the
  // game forward.
  int initialEmpty = BOARD_SIZE * BOARD_SIZE - 4;
  int result = (double)getNumEmpty() * GAME_MOVES / initialEmpty / 2;
